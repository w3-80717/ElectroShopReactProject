...
const Footer = () => {
  ...
  return (
    <div id='contact' className='w-full flex flex-col justify-center items-center'>
      ...
      {/* 2st box start*/}
      <div className='w-full lg:px-20 px-5 py-[60px] bg-gray-100 grid 
      lg:grid-cols-[auto,auto,auto,auto,auto] grid-cols-2 justify-between items-start lg:gap-3 gap-10'>
        <div data-aos="zoom-in" data-aos-delay='200' className='flex flex-col justify-center items-start gap-10 grow'>
          <div className='flex flex-col justify-center items-center gap-4'>
            ...
            <p className='text-gray-500 text-justify'>"Demo electronics" typically refers to demonstration units or display models <br />used in retail stores so that customers can physically interact with <br />the product before buying it.</p>
          </div>
          <div className='flex flex-col justify-center items-center gap-4'>
            <h1 className='text-black text-xl capitalize font-semibold'>Download Our App</h1>
      ...
      <div className='w-full lg:px-20 px-5 py-[40px] bg-gray-100 '>
        ...
        <div className='w-full flex lg:flex-row flex-col justify-between items-center lg:gap-4 gap-10'>
          ...
          <div className="lg:w-[60%] w-full flex lg:flex-row flex-col justify-cente items-center gap-4 flex-grow">
      ...
      <div id="icon-box" className="bg-themepurple text-white p-3 rounded-full
hover:bg-themeyellow hover:text-black cursor-pointer fixed 1g:bottom-6 right-bottom-6">
